...
void setup() {
  ...
  Serial.println("ESP32_1 ready to communicate");
}
...
void loop() {
  ...
  if (currentMillis - lastSendTime >= sendInterval) {
    ...
    MySerial.println("Hello from ESP32_1");
    Serial.println("Sent: Hello from ESP32_1");
  }

  // Check if data is received from ESP32_2
  if (MySerial.available()) {
    String received = MySerial.readString();
    Serial.println("Received from ESP32_2: " + received);
  }
}
